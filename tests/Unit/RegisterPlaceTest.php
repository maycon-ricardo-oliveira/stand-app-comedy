...
class RegisterPlaceTest extends UnitTestCase
{
    ...
    public function testRegisterPlace()
    {
        ...
        $placeData = [
            "name" => "Espaço Cultural Urca ". $this->uuid->id(),
            "seats" => 200,
    ...
    public function testMustReturnExceptionToRegisterPlace()
    {
        $this->expectException(PlaceAlreadyRegisteredException::class);
